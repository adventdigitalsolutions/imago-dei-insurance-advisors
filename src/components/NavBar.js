...
export default function NavBar () {
  ...
  return (
    <header className="py-4 bg-[#f9fafb] sm:py-5 w-full" x-data="{expanded: false}">
      <div className="px-4 mx-auto sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <div className="shrink-0 flex gap-8 items-center">
            ...
            <a href="/home" title="" className="hidden md:inline-flex items-center justify-center px-4 py-2.5 text-lg font-medium text-gray-900 transition-all duration-200 border border-transparent rounded-full hover:border-[1px] hover:border-yellow-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring-300">
              Home Page
            </a>
          </div>
          ...
          <div className="hidden md:flex lg:items-center lg:space-x-4 lg:justify-end lg:ml-auto">
            ...
            <a href="/contact" title="" className="inline-flex items-center justify-center px-4 py-2.5 text-lg font-medium text-gray-900 transition-all duration-200 border border-transparent rounded-full hover:border-[1px] hover:border-yellow-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring-300 gap-2">
