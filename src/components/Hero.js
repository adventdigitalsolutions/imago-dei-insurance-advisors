      ...
      <main className="lg:relative">
        <div className="mx-auto w-full pb-20 pt-16 text-center xlg:py-48 xl:text-left">
          <div className="px-6 sm:px- xl:w-2/3 xl:pr-16 flex flex-col gap-6 items-center xl:items-start">
            <div className="my-0 text-4xl font-normal tracking-wide text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              <h1>
                <span className="block xl:inline">Imago Dei</span>
              </h1>
              <h1>
            ...
            <p className="mt-3 max-w-md text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">Bringing a <span className="underline italic font-semibold"> Christian Worldview </span> to Health Benefits</p>
