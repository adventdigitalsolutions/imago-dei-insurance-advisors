...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      '6xl': ['clamp(5.96rem, 0vi + 5.96rem, 5.96rem)', '6.25rem'],
      '7xl': ['clamp(7.45rem, 0vi + 7.45rem, 7.45rem)', '7rem'],
      '8xl': ['clamp(9.31rem, 0vi + 9.31rem, 9.31rem)', '8.5rem'],
      '9xl': ['clamp(11.64rem, 0vi + 11.64rem, 11.64rem)', '11rem'],
    },
  plugins: [],
  }
}